    ...
    if (canvas) {
        ...
        class Snowflake {
            ...
            constructor() {
                ...
                this.radius = Math.random() * 4 + 1.5; // larger flakes
                this.speedY = Math.random() * 0.4 + 0.1; // slower fall
            ...
            update() {
                ...
                if (this.x > width) this.x = -this.radius;
                else if (this.x < 0) this.x = width + this.radius;
            }
            ...
            draw(context: CanvasRenderingContext2D) {
                ...
                // Realistic "Dirty White" with blurred edges
                gradient.addColorStop(0, `rgba(203, 213, 225, ${this.opacity})`);
                gradient.addColorStop(0.6, `rgba(203, 213, 225, ${this.opacity * 0.5})`);
